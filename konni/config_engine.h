...
#define ENGINE_CONFIG     ENGINE_HOOK(KC_A, AA) ENGINE_HOOK(KC_R, AS) ENGINE_HOOK(KC_S, AE) ENGINE_HOOK(KC_T, AT) ENGINE_HOOK(KC_N, AN) ENGINE_HOOK(KC_E, AI) ENGINE_HOOK(KC_I, AO) ENGINE_HOOK(KC_O, AP) ENGINE_HOOK(KC_SPC, AL) ENGINE_HOOK(KC_ENT, AR)